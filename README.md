...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Gailerking/Rose-Bot)<br>
...
class Development(Config):
    OWNER_ID = 973723932  # my telegram ID
    OWNER_USERNAME = "SonOfLars"  # my telegram username
    API_KEY = " 5952371481:AAEO8dVqZXvTnt-7v0puNA3bs3h-1KsGmnY"  # my api key, as provided by the botfather
